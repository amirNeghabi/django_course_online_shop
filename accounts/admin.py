...
class CustomUserAdmin(ModelAdminJalaliMixin, UserAdmin):
    ...
    def get_user_statistics(self, obj):
        ...
        total_spent_formatted = f'{total_spent:,}'
        ...
        html += f'<tr><td><strong>مجموع خرید:</strong></td><td style="color: #28a745;"><strong>{total_spent_formatted} تومان</strong></td></tr>'
